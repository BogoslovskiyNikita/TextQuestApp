...
class Replics{
     ...
     init {
         ...
         //  -10hp
         var r22 = HpChanchingRepilca("Ну зачем ты так делаешь? \n" +
         ...
         var r72 = HpChanchingRepilca("Ты оказался прав, яблоко - не ядовитое, и Ева съела именно \"запретный плод\", нигде не указывается, что это было именно яблоко.",
             "Пройти дальше", "-1", "-1",
             74,-1, -1, false, false, 20)


         //минус 10 хп
         var r73 = HpChanchingRepilca("Ну и ладно, но яблоко-то всё-таки полностью безопасное. \n" +
