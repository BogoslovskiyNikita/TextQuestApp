...
class Replics{
     ...
     init {
         var r1 = Replica(
             "Чтобы подзаработать немного денег ты согласился поучаствовать в одном эксперименте. Реклама громко гласила: \"Хочешь внести вклад в науку, пройдя всего один квест? Хочешь подзаработать 1000 евро, если сможешь выбраться из комнаты за 1 час и меньше?  Хочешь оставить свой отпечаток в истории психологии? Тогда приходи к нам! Звони по номеру 20-03-20, узнай все подробности!\" \n" +
                     "Когда ты позвонил по этому номеру, тебя приветствовал голос явно молодой девушки. Она заботливо узнала о тебе все, начиная от цвета глаз, заканчивая размером обуви. Спросила про образование и вредные привычки (у тебя их нет!). Тебе очень нужны были эти деньги. Тем более это же халява!  Поиграл да еще и деньги заплатили. Поэтому ты рассказал ей всё и даже больше. \n" +
                     "\n" +
                     "В назначенный час ты пришел в их офис. Кажется, что... нет, это точно она! Тебя встречает девушка из телефона. Ты смотришь ей в рот, ибо оттуда льется все тот же мягкий, успокаивающий голос. Она просит тебя присесть и надевает плотную черную повязку на глаза. Говорит, мол, для чистоты эксперимента ты не должен знать, где окажешься. Накатывает сон, ты уже не можешь сдержать позывы зевоты. \n" +
                     "Не стоило пить их чай. Ты собираешься им сказать об этом, предупредить, что чай-то их необычный, спать от него хочется, но уже не можешь. Ты ощущаешь, как твою голову прислоняют к подушке. Морфей уже ждет тебя с распростертыми руками... \n" +
         ...
         //the end
         var r18 = SpecialReplica("Друг мой. Слушать надо свой голос. \n" +
         ...
         //  -10hp
         var r22 = SpecialReplica("Ну зачем ты так делаешь? \n" +
         ...
         var r24 = SpecialReplica("Ты взял фонарь в правую руку. Как заметили ранее, у тебя нет карманов, поэтому у тебя осталась всего одна рука свободная. \n" +
                 "Береги её.",
             "Идти дальше, освещая себе путь фонарём", "-1", "-1",
             26,-1, -1, false, false)

         //добавляется предмет факел в правую руку
         var r25 = SpecialReplica("Ты взял факел в правую руку. Как заметили ранее, у тебя нет карманов, поэтому у тебя осталась всего одна рука свободная. \n" +
                 "Береги её.",
             "Идти дальше, освещая себе путь фонарём", "-1", "-1",
             26,-1, -1, false, false)
         ...
         //blanket YES or NO
         var r30 = Replica("Ты завернул за угол, прошел до конца очередного ветвления, завернул направо, затем до конца и налево. \n" +
                 "Ты идешь уже приличиных четыре минут и достаточно устал!",
             "Прилечь отдохнуть blanketYes", "Некогда отдыхать, двигаем дальше", "Прилечь отдохнуть blanketYes",
             31,35, 91, true, true)

         //есть ли одеяло у героя (blanketYes)
         var r31 = SpecialReplica("Хоть и стоит адская холодрыга, тебе удается оставаться в сознании, лежа на полу, ибо захватил одеяло и лежишь на нем.",
             "\"- Предусмотрительность моё второе имя!\"", "-1", "-1",
             32,-1, -1, false, false)

         //есть ли одеяло у героя (blanketNo)
         var r91 = SpecialReplica("Дурашка, зачем ты лег нагим на ледяной пол?",
         ...
         //the end
         var r34 = SpecialReplica("Ты не заметил, как к тебе сзади подползла змея. Они же очень тихие, не правда ли? \n" +
                 "Ты укушен. \n" +
                 "Сломлен. \n" +
                 "Разбит и подвален. \n" +
                 "А еще ты проиграл.",
         ...
         var r43 = Replica("00-00-01...\n" +
                 "00-00-02...\n" +
                 "00-00-03...\n" +
                 "...\n" +
                 "00-00-30...",
             "Устал...", "Продолжить подбирать flashlightYes", "Продолжить подбирать flashlightNo",
             44,45, 92, true, true)
         ...
         var r45 = SpecialReplica("00-00-40...\n" +
                 "00-00-41...\n" +
                 "00-00-42...\n" +
                 "...\n" +
                 "00-26-99...\n" +
         ...
         var r92 = SpecialReplica("00-00-40...\n" +
                 "00-00-41...\n" +
                 "00-00-42...\n" +
                 "...\n" +
                 "00-26-99...\n" +
         ...
         //the end
         var r46 = SpecialReplica("Ты еле в потёмках нашел то место, но там не осталось даже табуретки. \n" +
         ...
         var r49 = Replica("Да хорош стонать. Жить же так здорово здорово! А ты жив, так что все супер гуд.\n" +
                 "- Татарстан супер гуд...\n" +
                 "Бер, ике, эч, дурт! Ну вот, не теряешь оптимизма.",
             "Двигаться дальше, напевая песенку flashlightYes", "Двигаться дальше, напевая песенку flashlightNo", "-1",
             50,94, -1, true, false)

         //что именно у героя: фонарь (flashlightYes)
         var r50 = SpecialReplica("Ты уже замечал, как твой фонарик тухнет, но подумал, что он еще сможет долго прожить. \n" +
         ...
         //что именно у героя: факел (flashlightNo)
         var r94 = SpecialReplica("Ты так сильно был занят вглядыванием в темноту, что не заметил, как у тебя погас твой факел тем потоком обжигающе холодного воздуха, который прошелся с тобой рядом, когда захлопнулась дверь.",
             "Расстроиться", "-1", "-1",
             51,-1, -1, false, false)
         ...
         //минус 20 хп
         var r56 = SpecialReplica("Ты добежал до конца коридора и чуть не вляпался в дверь. Подергал, но безрезультатно, она заперта. \n" +
                 "Упал на пол и копчиком нащупал пистолет.",
             "Взять пистолет", "-1", "-1",
             57,-1, -1, false, false)

         //добавляется предмет пистолет в правую руку
         var r57 = SpecialReplica("Слава твоему ОБЖшнику, ты знаешь, где снимать пистолет с предохранителя. Ты его снял и направил в темноту, в ту сторону, откуда издавались запыхивающиеся звуки.\n" +
                 "Животное очень близко!",
             "Стрелять!", "Подождать ещё немного", "-1",
             61,60, -1, true, false)

         //добавляется предмет нож в правую руку
         var r58 = SpecialReplica("В тебе заиграла природа, ты чувствуешь, что главная цель сейчас - выжить!\n" +
         ...
         var r59 = SpecialReplica("Ты решаешь, что это все-таки собака и что она успокоиться и отстанет от тебя, если ты кинешь ей игрушку. Проверим...\n" +
         ...
         //the end
         var r60 = SpecialReplica("Оно налетело на тебя так мгновенно, что ты ничего не успел предпринять, ты встрелил, но мимо. \n" +
         ...
         //the end
         var r62 = SpecialReplica("Не происходит ровным счётом ничего. Животное всё также несется на тебя. Ты инстинктивно закрываешь лицо руками. \n" +
         ...
         var r63 = SpecialReplica("Животное налетело на тебя, первый удар пришелся ему. \n" +
         ...
         //минус 60 хп
         //левая рука недееспособна
         var r64 = SpecialReplica("Животное неустанно бежит к тебе. Первый КУСЬ сделало оно. Ты почувствовал, как его клыки вонзаются в твою левую руку и протыкают её насквозь. От прилива адреналина ты вонзил нож в брюхо волка, да, кажется, это волк, и животное замертво пало. \n" +
         ...
         //добавляется предмет пистолет в правую руку
         var r66 = SpecialReplica("В связи с последними событиями, он может вполне сгодиться для чего-то. Но он такой ледяной...",
             "Осмотреть дверь", "-1", "-1",
             71,-1, -1, false, false)

         //добавляется предмет окровавленный нож в правую руку
         var r67 = SpecialReplica("Были б штаны, ты б его об штаны обтёр. Но, увы, их как не было, так и нет.",
             "Осмотреть дверь", "-1", "-1",
             71,-1, -1, false, false)

         //добавляется предмет собачья игрушка в правую руку
         var r68 = SpecialReplica("Не самое лучшее решение. Зато развлечься можно, если будет скучно.",
             "Осмотреть дверь", "-1", "-1",
             71,-1, -1, false, false)

         //добавляется предмет нож в левую руку
         var r69 = SpecialReplica("Неплохо, может сгодиться.",
             "Осмотреть дверь", "-1", "-1",
             71,-1, -1, false, false)

         //добавляется предмет собачья игрушка в левую руку
         var r70 = SpecialReplica("Не самое лучшее решение. Зато развлечься можно, если будет скучно.",
             "Осмотреть дверь", "-1", "-1",
             71,-1, -1, false, false)
         ...
         var r72 = SpecialReplica("Ты оказался прав, яблоко - не ядовитое, и Ева съела именно \"запретный плод\", нигде не указывается, что это было именно яблоко.",
             "Пройти дальше", "-1", "-1",
             74,-1, -1, false, false)


         //минус 10 хп
         var r73 = SpecialReplica("Ну и ладно, но яблоко-то всё-таки полностью безопасное. \n" +
         ...
         //todo
         var r74 = SpecialReplica("",
             "knifeYes", "knifeNo", "-1",
             104,105, -1, true, false)

         //knifeYes
         var r104 = SpecialReplica("",
             "gunYes", "gunNo", "-1",
             109,106, -1, true, false)

         //knifeNo
         var r105 = SpecialReplica("",
             "gunYes", "gunNo", "-1",
             107,112, -1, true, false)

         //knifeYes gunNo
         var r106 = SpecialReplica("",
             "petuhYes", "petuhNo", "-1",
             10,108, -1, true, false)
         ...
         //knifeNo gunYes
         var r107 = SpecialReplica("",
             "petuhYes", "petuhNo", "-1",
             110,111, -1, true, false)

         //knifeYesGunNoPetuhNo
         var r108 = SpecialReplica("Пройдя дальше, ты увидел невообразимое! Огромные ворота под самые небеса, которых даже не видно. \n" +
         ...
         var r109 = SpecialReplica("Пройдя дальше, ты увидел невообразимое! Огромные ворота под самые небеса, которых даже не видно. \n" +
                 "Перед ними стоят два стражника. Не как ты подумал, в доспехах и с копьями, а в броннике и с калашом на плече. \n" +
                 "Они смотрят в твою сторону, но, кажется, тебя не видят. \n" +
                 "Они выглядят опасными, но если бы тебе хотели зла, давно бы уже его причинили. \n" +
                 "Что думаешь делать?",
         ...
         var r110 = SpecialReplica("Пройдя дальше, ты увидел невообразимое! Огромные ворота под самые небеса, которых даже не видно. \n" +
                 "Перед ними стоят два стражника. Не как ты подумал, в доспехах и с копьями, а в броннике и с калашом на плече. \n" +
                 "Они смотрят в твою сторону, но, кажется, тебя не видят. \n" +
                 "Они выглядят опасными, но если бы тебе хотели зла, давно бы уже его причинили. \n" +
                 "Что думаешь делать?",
         ...
         var r111 = SpecialReplica("Пройдя дальше, ты увидел невообразимое! Огромные ворота под самые небеса, которых даже не видно. \n" +
                 "Перед ними стоят два стражника. Не как ты подумал, в доспехах и с копьями, а в броннике и с калашом на плече. \n" +
                 "Они смотрят в твою сторону, но, кажется, тебя не видят. \n" +
                 "Они выглядят опасными, но если бы тебе хотели зла, давно бы уже его причинили. \n" +
                 "Что думаешь делать?",
         ...
         var r112 = SpecialReplica("Пройдя дальше, ты увидел невообразимое! Огромные ворота под самые небеса, которых даже не видно. \n" +
                 "Перед ними стоят два стражника. Не как ты подумал, в доспехах и с копьями, а в броннике и с калашом на плече. \n" +
                 "Они смотрят в твою сторону, но, кажется, тебя не видят. \n" +
                 "Они выглядят опасными, но если бы тебе хотели зла, давно бы уже его причинили. \n" +
                 "Что думаешь делать?",
         ...
         //the end
         var r75 = SpecialReplica("Ты очень явно и громко бежал на них, сверкая своим мачете. Они не такие простаки, как ты, поэтому схватили свои аппараты, направили на тебя и... \n" +
                 "И игра закончилась. \n" +
         ...
         //the end
         var r76 = SpecialReplica("Нет, нет и еще раз нет. У тебя конечно ничего не вышло. Ты думаешь, что ты такой профи? \n" +
         ...
         //the end GOOD
         var r78 = SpecialReplica("Тебя встретили чуть дальше. Трясли за плечи и снова хохотали. \n" +
         ...
         //два полцарства
         var r81 = SpecialReplica("'Нет. Я абсолютно серьёзен. Ты сразишься с моим другом - Деревянным Дедом.'",
             "В бой!", "-1", "-1",
             -10,-1, -1, false, false)

         //два полцарства
         var r82 = SpecialReplica("'А что-то не так? Одного полцартсва будет маловато, чтобы пройти дальше.'",
         ...
         //кнб
         var r114 = SpecialReplica("'Хех, пошутил я. Тебе здесь точно не выиграть. Я мастер. Будем играть в 'камень-ножница-бумага'. Но и там у тебя мало шансов, друг мой. Я знаю секретные тактики, доступные только шаолинским монахам.'",
             "\"Погнали\"", "-1", "-1",
             -11,-1, -1, false, false)
